...
class _$LoginDataImpl implements _LoginData {
  const _$LoginDataImpl(
      {this.accessToken, this.refreshToken, this.user, this.sessionId});
  ...
  @override
  String toString() {
    return 'LoginData(accessToken: $accessToken, refreshToken: $refreshToken, user: $user, sessionId: $sessionId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, user, sessionId);
...
abstract class _LoginData implements LoginData {
  const factory _LoginData(
      ...
      final String? refreshToken,
      final UserModel? user,
      final String? sessionId}) = _$LoginDataImpl;
